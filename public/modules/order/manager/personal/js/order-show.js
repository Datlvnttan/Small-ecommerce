...
//     const routeFeedbackStore = "api.order.personal.order.feedback.store";
//     const routeFeedbackUpdate = "api.order.personal.order.feedback.update";
//     const routeFeedbackDelete = "api.order.personal.order.feedback.destroy";
//     // alert(route(routeFeedbackStore))
//     window.ORDER_DETAIL = {
//         LOAD: {
//             fetchDataOrderDetail: (id) => {
//                 new CallApi(
//                     route("api.order.personal.order.show", { id: id })
//                 ).get(
//                     (res) => {
//                         console.log(res);
//                         ORDER_DETAIL.UI.LOAD_DATA.populateDataOrderDetail(
//                             res.data
//                         );
//                     },
//                     (res) => {
...
//                     // console.log(order);
//                     $("#order-order_key").text(order.order_key ?? order.id);
...
//                         dis = 0;
//                     }
//                     $("#order-discount_coupon_discount").text(dis);
...
//                         (
//                             order.shipping_method.expense *
//                             (1 - order.shipping_method.discount)
//                         ).toLocaleString("en-US")
//                     );
//                     $("#order-total_amount").text(
//                         order.total_amount.toLocaleString("en-US")
//                     );
//                     const createFeedback = order.status == "Delivered";
...
//                                         <div class="image-product" style="background: url(${HELPER.getUrlProductImage(
//                                             orderDetail.sku.product
...
//                     $(`#${orderDetail.feedback_rating}_star`).prop(
//                         "checked",
//                         true
//                     );
