...
@section('setup-css')
    ...
    <link href="{{ asset('library/css/suggestion.css') }}" rel="stylesheet">
    @yield('css')
@endsection
                ...
                <div class="container">
                    <div class="row small-gutters">
                        <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                            <div id="logo">
                                <a href="{{ route('web.home.index') }}"><img src="{{ asset('img/logo.svg') }}"
                        ...
                        <nav class="col-xl-6 col-lg-7">
                            ...
                            <div class="main-menu">
                                <div id="header_menu">
                                    <a href="{{ route('web.home.index') }}"><img src="{{ asset('img/logo_black.svg') }}"
                                            alt="" width="100" height="35"></a>
                                            ...
                                            <div class="row small-gutters">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ route('web.order.trackOrder') }}">Track Order</a>
                                                        </li>
                                                    ...
                                                    <div class="banner_menu">
                                                        <a href="#0">
                                                            <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                                data-src="{{ asset('img/banner_menu.jpg') }}"
                ...
                <div class="container">
                    <div class="row small-gutters">
                        <div class="col-xl-3 col-lg-3 col-md-3">
                            <nav class="categories" id="menu_categories">
                                <ul class="clearfix">
                                    <li><span>
                                            <a href="#">
                        ...
                        <div class="col-xl-6 col-lg-7 col-md-6 d-none d-md-block">
                            {{-- <form class="custom-search-input " action="{{route('web.product.search')}}">
                                <input type="text" name="txtSearch" placeholder="Search over 10.000 products">
                                <button type="submit"><i class="header-icon_search_custom"></i></button> 
                            </form> --}}

                            <form class="custom-search-input" id="form-search" action="{{ route('web.product.search') }}">
                                <div class="search-input">
                                    <div class="tags-input">
                                        <div id="suggestions-box" class="list-group box-tag"></div>
                                        <div class="search-box">
                                            <input type="text" name="q" id="search-box"
                                                placeholder="Search over 10.000 products" autocomplete="off">
                                            <button type="submit" id="btn-search"><i class="header-icon_search_custom"></i></button>
                                        </div>
                                    </div>

                                    <div class="autocom-box">
                                        {{-- <div class="autocom-box-option autocom-box-products"></div>
                                        <div class="autocom-box-option autocom-box-categories"></div>
                                        <div class="autocom-box-option autocom-box-brands"></div> --}}
                                    </div>
                                </div>
                            </form>
                            ...
                            <ul class="top_tools">
                                <li>
                                    <div class="dropdown dropdown-cart">
                                        <a href="{{ route('web.cart.index') }}" class="cart_bt"><strong
                                                id="header_cart_total_quantity">2</strong></a>
                                        <div class="dropdown-menu">
                                            <ul id="dropdown_cart_menu">
                                                <li>
                                                    <a href="product-detail-1.html">
                                                        ...
                                                        <strong><span>1x Armor Air x Fear (options 1 2 3
                                                                4)</span>$90.00</strong>
                                                    </a>
                                            ...
                                            <div class="total_drop">
                                                <div class="clearfix"><strong>Total</strong><span
                                                        id="header-cart-subtotal">$200.00</span></div>
                                                <a href="{{ route('web.cart.index') }}" class="btn_1 outline">View
                                                    Cart</a>
                                    ...
                                    <div class="dropdown dropdown-access">
                                        ...
                                        <div class="dropdown-menu">
                                            @if ($user)
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="{{ route('web.order.personal.order.index') }}"><i
                                                                class="ti-package"></i>My Orders</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('web.personal.profile') }}"><i
                                                ...
                                                <a href="{{ route('web.auth.logout') }}" class="btn_1">Log out</a>
                                            @else
